...
class CDEvaluator():
    ...
    def __init__(self, dataloader):
        ...
        self.checkpoint_dir = "checkpoints_attention_cdd(11.25 lr=0.01 batch=24)/"
    ...
    def _load_checkpoint(self, checkpoint_name='best.pt'):
        ...
        if os.path.exists(os.path.join(self.checkpoint_dir, checkpoint_name)):
            ...
            self.logger.write('Eval Historical_best_f1 = %.4f (at epoch %d)\n' %
    ...
    def _collect_running_batch_states(self, labels):
        ...
        running_mf1 = self._update_metric(labels)
    ...
    def _forward_pass(self, imageA, imageB):
        ...
        #G1_12,G2_12,G1_22,G2_22,G1_32,G2_32,G1_42,G2_42,G1_11,G2_11,G1_21,G2_21,G1_31,G2_31,G1_41,G2_41,A,B,C,D,self.G_pred = self.net_G(img_in1, img_in2)
        A,B,C,D,self.G_pred = self.net_G(img_in1, img_in2)
    ...
    def eval_models(self, checkpoint_name='best.pt'):
        ...
        ################## Eval ##################
        ##########################################
        self.logger.write('开始 evaluation...\n')
        self._clear_cache()
        self.is_training = False
        self.net_G.eval()
...
if __name__ == '__main__':
    ...
    train_dataloader, test_dataloader, val_dataloader, batch_size = load_img('E:/dataset/CDD_FC/')
