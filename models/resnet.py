...
class ResNet(nn.Module):
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
        ...
        self.conv1 = nn.Conv2d(3, self.inplanes, kernel_size=3, stride=self.strides[0], padding=1,
                               bias=False)
        ...
        self.layer2 = self._make_layer(block, 64, layers[1], stride=self.strides[2],
                                       dilate=replace_stride_with_dilation[0])
        self.layer3 = self._make_layer(block, 128, layers[2], stride=self.strides[3],
...
def resnet18(pretrained=False, progress=True, **kwargs):
    return _resnet('resnet18', BasicBlock, [1, 2, 2, 2], pretrained, progress,
                   **kwargs)
...
if __name__ == '__main__':
    ...
    out2 = resnet(x)
    print(out2[0].shape,out2[1].shape,out2[2].shape,out2[3].shape,out2[4].shape)
